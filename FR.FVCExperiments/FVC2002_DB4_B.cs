...
{
    /// <summary>
    ///     Allows testing a fingerprint matching algorithm in database DB4_B from FVC2002.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    ///     </para>
    ///     <para> 
    ///         In order to execute the experiment, you must set the properties <see cref="Matcher"/>, <see cref="ResourceProvider{ResourceType}"/> and <see cref="ResourcePath"/>. Optionally, you can set the property <see cref="StatusEvent"/> in order to get updates concerning the status of the experiment.
    ///     </para>
    /// </remarks>
    public class FVC2002_DB4_B : FVC_DB_B 
    {
